This code develops a binary imagine classifier for the pneumonia using the chest xray data from: https://www.kaggle.com/paultimothymooney/chest-xray-pneumonia. 
